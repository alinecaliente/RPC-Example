...
int trocasimbolos(char symbol1, char symbol2) {
	return symbol_args;
}
...
int play(int row, int column, int player) {
    ...
    board[row][column] = (player == 1) ? symbol1 : symbol2;  /* Insert player symbol   */
